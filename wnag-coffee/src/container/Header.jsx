...
const Header = () => {
  return (
    <div
      className='flex flex-col items-center justify-center bg-white px-24 py-16 md:flex-row'
      id='home'
    >
      <div className='items-flex-start flex w-full flex-1 flex-col justify-center'>
        <div className='mb-4'>
      ...
      <div className='mt-20 flex w-full flex-1 items-center justify-center xl:ml-4'>
        <img
