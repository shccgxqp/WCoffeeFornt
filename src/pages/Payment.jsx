  ...
  return (
    <>
      <div className='flex h-screen w-full flex-col items-center justify-center'>
        ...
        <form ref={formRef} name='Spgateway' className='flex flex-col' action={tradeInfo.PayGateWay} method='post'>
          ...
          <input type='hidden' name='ClientBackURL' value={tradeInfo.ClientBackURL} />
