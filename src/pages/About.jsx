...
const About = () => {
  return (
    <div className='mx-auto rounded-md bg-white p-8 px-24  shadow-md'>
      <div className='mt-8 flex items-center justify-center'>
        ...
        <div className='w-2/5'>
          <img src={images.bg02} alt='img' className='p-8' />
        </div>
      </div>
      ...
      <p className='py-12 text-center text-xl font-semibold sm:px-8'>
